...
class SynthesisFilter
{
  ...
  void compute_pcm_samples (OutputAudioStream *);
...
public:
  ...
  void	calculate_pcm_samples (OutputAudioStream *);
	// calculate 32 PCM samples and put the into the AudioBuffer-object
